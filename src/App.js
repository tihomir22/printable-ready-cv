...
function App() {
  let strings = new LocalizedStrings({
    es: {
      ...
      experencia_laboral_list_item_1_job1: "Mantenimiento de proyectos legacy con frameworks antiguos.",
      experencia_laboral_list_item_2_job1: "Desarollo de proyectos totalmente nuevos de principio a fin.",
      experencia_laboral_list_item_3_job1: "Desarollo responsive y user friendly.",
      ...
      experencia_laboral_list_item_1_job3: "Gestión de documentación de vehiculos personales..",
    ...
    en: {
      ...
      experencia_laboral_list_item_1_job1: "Maintenance of legacy projects with old frameworks.",
      ...
      experencia_laboral_list_item_1_job3: "Management of personal vehicle documentation.",
  ...
  return (
    <div className="App">
      ...
      />
      <article className="resume-wrapper text-center position-relative" id="toPrint">
        <div className="resume-wrapper-inner mx-auto text-left bg-white shadow-lg">
            ...
            <div className="media flex-column flex-md-row">
              ...
              <div className="media-body p-4 d-flex flex-column flex-md-row mx-auto mx-lg-0">
                <div className="primary-info">
                  <h1 className="name mt-0 mb-1 text-white text-uppercase text-uppercase">Tihomir Stoychev Stoychev</h1>
                  <div className="title mb-3">Full Stack MEAN Developer</div>
                  <ul className="list-unstyled">
                    <li className="mb-2">
                      <a href="#">
                        <i className="far fa-envelope fa-fw mr-2" data-fa-transform="grow-3"></i>tihomir_alcudia3@hotmail.com
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <i className="fas fa-mobile-alt fa-fw mr-2" data-fa-transform="grow-6"></i>+34603680594
                      </a>
                    </li>
                  </ul>
                </div>
                <div className="secondary-info ml-md-auto mt-2">
                  <ul className="resume-social list-unstyled">
                    <li className="mb-3">
                      <a href="https://www.linkedin.com/in/tihomir-stoychev-stoychev/" target="_blank">
                    ...
                    <li className="mb-3">
                      <a href="https://tihomirstoychevstoychev.com/" target="_blank">
                        <span className="fa-container text-center mr-2">
          ...
          <div className="resume-body p-5">
            <section className="resume-section summary-section mb-5">
              <h2 className="resume-section-title text-uppercase font-weight-bold pb-3 mb-3">{strings.objetivos_label}</h2>
            ...
            <div className="row">
                  ...
                  <div className="resume-section-content">
                    <div className="resume-timeline position-relative">
                      <article className="resume-timeline-item position-relative pb-5">
                        <div className="resume-timeline-item-header mb-2">
                          <div className="d-flex flex-column flex-md-row">
                            <h3 className="resume-position-title font-weight-bold mb-1">{strings.experencia_laboral_title_job1}</h3>
                            <div className="resume-company-name ml-auto">PFS Group</div>
                          </div>
                          <div className="resume-position-time">{strings.experencia_laboral_date_job1}</div>
                        </div>
                        <div className="resume-timeline-item-desc">
                          ...
                          <p>{strings.experencia_laboral_competencias_desc_job1}</p>
                          <ul>
                            <li>{strings.experencia_laboral_list_item_1_job1}</li>
                            <li>{strings.experencia_laboral_list_item_2_job1}</li>
                            <li>{strings.experencia_laboral_list_item_3_job1}</li>
                            <li>{strings.experencia_laboral_list_item_4_job1}</li>
                          </ul>
                          <h4 className="resume-timeline-item-desc-heading font-weight-bold">
                          ...
                          <ul className="list-inline">
                            ...
                            <li className="list-inline-item">
                              <span className="badge badge-primary badge-pill">NodeJs</span>
                            </li>
                            <li className="list-inline-item">
                            ...
                            <li className="list-inline-item">
                              <span className="badge badge-primary badge-pill">MongoDB</span>
                            </li>
                            <li className="list-inline-item">
                              <span className="badge badge-primary badge-pill">Java</span>
                            </li>
                            <li className="list-inline-item">
                              <span className="badge badge-primary badge-pill">Docker/Docker-compose</span>
                            </li>
                            <li className="list-inline-item">
                              <span className="badge badge-primary badge-pill">Jenkins</span>
                            </li>
                            <li className="list-inline-item">
                              <span className="badge badge-primary badge-pill">Loopback</span>
                            </li>
                          </ul>
                        </div>
                      </article>
                      ...
                      <article className="resume-timeline-item position-relative pb-5">
                        <div className="resume-timeline-item-header mb-2">
                          <div className="d-flex flex-column flex-md-row">
                            <h3 className="resume-position-title font-weight-bold mb-1">{strings.experencia_laboral_title_job2}</h3>
                            <div className="resume-company-name ml-auto">Geinfor SL</div>
                          </div>
                          <div className="resume-position-time">{strings.experencia_laboral_date_job2}</div>
                        </div>
                        <div className="resume-timeline-item-desc">
                          ...
                          <p>{strings.experencia_laboral_competencias_desc_job2}</p>
                          <h4 className="resume-timeline-item-desc-heading font-weight-bold">
                            {strings.experencia_laboral_technologies_used}
                          </h4>
                          <ul className="list-inline">
                            ...
                            <li className="list-inline-item">
                              <span className="badge badge-primary badge-pill">HTML/SASS/Typescript</span>
                            </li>
                            <li className="list-inline-item">
                              <span className="badge badge-primary badge-pill">PostgresSQL</span>
                            </li>
                      ...
                      <article className="resume-timeline-item position-relative pb-5">
                        <div className="resume-timeline-item-header mb-2">
                          <div className="d-flex flex-column flex-md-row">
                            <h3 className="resume-position-title font-weight-bold mb-1">{strings.experencia_laboral_title_job3}</h3>
                            <div className="resume-company-name ml-auto">ITV Xativa</div>
                          </div>
                          <div className="resume-position-time">{strings.experencia_laboral_date_job3}</div>
                        </div>
                        <div className="resume-timeline-item-desc">
                          <p>{strings.experencia_laboral_desc_job3}</p>
                          <ul>
                            <li>{strings.experencia_laboral_list_item_1_job3}</li>
                            <li>{strings.experencia_laboral_list_item_2_job3}</li>
                            <li>{strings.experencia_laboral_list_item_3_job3}</li>
                            <li>{strings.experencia_laboral_list_item_4_job3}</li>
                          </ul>
                        </div>
                      </article>
                    </div>
              ...
              <div className="col-lg-3">
                <section className="resume-section skills-section mb-5">
                  <h2 className="resume-section-title text-uppercase font-weight-bold pb-3 mb-3">{strings.habilidades}</h2>
                  <div className="resume-section-content">
                    <div className="resume-skill-item">
                      <h4 className="resume-skills-cat font-weight-bold">Frontend</h4>
                      <ul className="list-unstyled mb-4">
                        <li className="mb-2">
                          <div className="resume-skill-name">Angular (+2 {strings.anyos})</div>
                        ...
                        <li className="mb-2">
                          <div className="resume-skill-name">React (+1 {strings.anyo})</div>
                          <div className="progress resume-progress">
                            <div
                              className="progress-bar theme-progress-bar-dark"
                              role="progressbar"
                        ...
                        <li className="mb-2">
                          <div className="resume-skill-name">JavaScript (+3 {strings.anyos})</div>
                          <div className="progress resume-progress">
                            <div
                              className="progress-bar theme-progress-bar-dark"
                              role="progressbar"
                        ...
                        <li className="mb-2">
                          <div className="resume-skill-name">ReactJs/Ionic (+1 {strings.anyo})</div>
                          <div className="progress resume-progress">
                            <div
                              className="progress-bar theme-progress-bar-dark"
                              role="progressbar"
                        ...
                        <li className="mb-2">
                          <div className="resume-skill-name">HTML/CSS/SASS/LESS (+3 {strings.anyos})</div>
                          <div className="progress resume-progress">
                            <div
                              className="progress-bar theme-progress-bar-dark"
                              role="progressbar"
                    ...
                    <div className="resume-skill-item">
                      ...
                      <ul className="list-unstyled">
                        <li className="mb-2">
                          <div className="resume-skill-name">Python (+1 {strings.anyo})</div>
                          <div className="progress resume-progress">
                            <div
                              className="progress-bar theme-progress-bar-dark"
                              role="progressbar"
                        ...
                        <li className="mb-2">
                          <div className="resume-skill-name">Node.Js + frameworks (+2 {strings.anyos}) </div>
                          <div className="progress resume-progress">
                            <div
                              className="progress-bar theme-progress-bar-dark"
                              role="progressbar"
                        ...
                        <li className="mb-2">
                          <div className="resume-skill-name">PHP (+6 {strings.meses})</div>
                          <div className="progress resume-progress">
                            <div
                              className="progress-bar theme-progress-bar-dark"
                              role="progressbar"
                        ...
                        <li className="mb-2">
                          <div className="resume-skill-name">Java + frameworks (2 {strings.anyos})</div>
                          <div className="progress resume-progress">
                            <div
                              className="progress-bar theme-progress-bar-dark"
                              role="progressbar"
                    ...
                    <div className="resume-skill-item">
                      <h4 className="resume-skills-cat font-weight-bold">{strings.otros}</h4>
                      <ul className="list-inline">
                        <li className="list-inline-item">
                          <span className="badge badge-light">DevOps</span>
                        </li>
                        <li className="list-inline-item">
                          <span className="badge badge-light">{strings.revision_codigo}</span>
                        </li>
                        <li className="list-inline-item">
                          <span className="badge badge-light">Git</span>
                        </li>
                        <li className="list-inline-item">
                          <span className="badge badge-light">{strings.testing_unitario}</span>
                        </li>
                        <li className="list-inline-item">
                        ...
                        <li className="list-inline-item">
                          <span className="badge badge-light">Native/Mobile</span>
                        </li>
                        <li className="list-inline-item">
                ...
                <section className="resume-section education-section mb-5">
                  <h2 className="resume-section-title text-uppercase font-weight-bold pb-3 mb-3">{strings.educacion}</h2>
                  <div className="resume-section-content">
                    <ul className="list-unstyled">
                      <li className="mb-2">
                        <div className="resume-degree font-weight-bold">{strings.educacion_titulo_1}</div>
                        <div className="resume-degree-org">{strings.educacion_colegio_1}</div>
                        <div className="resume-degree-time">2017 - 2019</div>
                      </li>
                      <li>
                        <div className="resume-degree font-weight-bold">{strings.educacion_titulo_2}</div>
                        <div className="resume-degree-org">{strings.educacion_colegio_1}</div>
                ...
                <section className="resume-section reference-section mb-5">
                  <h2 className="resume-section-title text-uppercase font-weight-bold pb-3 mb-3">{strings.premios}</h2>
                  <div className="resume-section-content">
                    <ul className="list-unstyled resume-awards-list">
                      <li className="mb-2 pl-4 position-relative">
                        ...
                        <div className="resume-award-name">{strings.titulo_premio_1}</div>
                        <div className="resume-award-desc">{strings.desc_premio_1}</div>
                      </li>
                      <li className="mb-0 pl-4 position-relative">
                        <i className="resume-award-icon fas fa-trophy position-absolute" data-fa-transform="shrink-2"></i>
                        <div className="resume-award-name">{strings.titulo_premio_2}</div>
                        <div className="resume-award-desc">{strings.desc_premio_2}</div>
                      </li>
                    </ul>
                  </div>
                </section>
                <section className="resume-section language-section mb-5">
                  <h2 className="resume-section-title text-uppercase font-weight-bold pb-3 mb-3">{strings.idiomas}</h2>
                  <div className="resume-section-content">
                    <ul className="list-unstyled resume-lang-list">
                      <li className="mb-2">
                        <span className="resume-lang-name font-weight-bold">{strings.espanyol}</span>{" "}
                        <small className="text-muted font-weight-normal">({strings.native})</small>
                      </li>
                      <li className="mb-2 align-middle">
                        <span className="resume-lang-name font-weight-bold">{strings.english}</span>{" "}
                        <small className="text-muted font-weight-normal">({strings.professional} - B2)</small>
                      </li>
                      <li>
                        <span className="resume-lang-name font-weight-bold">{strings.bulgarian}</span>{" "}
                        <small className="text-muted font-weight-normal">({strings.native})</small>
                      </li>
                    </ul>
                  </div>
